...
plt.title('Ypredict vs Yatual for File 292',fontsize=12)

plt.savefig('Predicted vs actual 292.pdf',format='pdf')
plt.close()
print "The RMS of 292 first 100 days is:",math.sqrt(((predictedprice-ldfdata[:,0][25:100])**2).mean(axis=0))
print "The correlation of 292 first 100 days is:",np.corrcoef(predictedprice,ldfdata[:,0][25:100])[1,0]
end=time.clock
time=end-start
print time
